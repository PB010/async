    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("25320c5e-f58a-4b1f-b63a-8ee07a840bdf"), "Stephen", "King" },
                    { new Guid("76053df4-6687-4353-8937-b45556748abe"), "George", "RR Martin" },
                    { new Guid("412c3012-d891-4f5e-9613-ff7aa63e6bb3"), "Neil", "Gaiman" },
                    { new Guid("578359b7-1967-41d6-8b87-64ab7605587e"), "Tom", "Lanoye" },
                    { new Guid("f74d6899-9ed2-4137-9876-66b070553f8f"), "Douglas", "Adams" },
                    { new Guid("a1da1d8e-1988-4634-b538-a01709477b77"), "Jens", "Lapidus" }
                });
